...
/**
 * The {@link NetworkTables} class is the bridge between robot programs and the
 * FFDashboard on the laptop.
 *
 * <p>
 * When a value is put into the FFDashboard here, it pops up on the FFDashboard
 * on the laptop. Users can put values into and get values from the FFDashboard.
 */
public class FFDashboard {

	private NetworkTable table = NetworkTableInstance.getDefault().getTable("FFDashboard");

	private FFDashboard() {
		table = NetworkTableInstance.getDefault().getTable("FFDashboard");
	}

	public FFDashboard(String subTable) {
		table = (NetworkTableInstance.getDefault().getTable("FFDashboard").getSubTable(subTable));
	}

	private static FFDashboard instance = new FFDashboard();

	public static FFDashboard getInstance() {
		return instance;
	}
	// public enum SubTables {
	// INTAKE("Intake"), DRIVE("Drive"), SHIFT("Shift"), ELEVATOR("Elevator"),
	// CARRIAGE("Carriage"), GYRO("Gyro"),
	// TEST("Test");
	//
	// private NetworkTable subTable;
	//
	// SubTables(String subTable) {
	// this.subTable = table.getSubTable(subTable);
	// }
	//
	// public NetworkTable getSubTable() {
	// return subTable;
	// }
	// }

	/**
	 * The {@link NetworkTable} used by {@link NetworkTables}.
	 */
	...
	/**
	 * A table linking tables in the SmartDashboard to the {@link Sendable} objects
	 * they came from.
	 */
	 ...
	 * {@link NamedSendable} to the specified value in this table. The value can be
	...
	/**
	 * Makes a key's value persistent through program restarts. The key cannot be
	 * null.
	 *
	 * @param key the key name
	 */
	...
	/**
	 * Stop making a key's value persistent through program restarts. The key cannot
	 * be null.
	 *
	 * @param key the key name
	 */
	...
	/**
	 * Returns the string array the key maps to. If the key does not exist or is of
	 * different type, it will return the default value.
	 * 
	 * @param key          the key to look up
	 * @param defaultValue the value to be returned if no value is found
	...
	/**
	 * Returns the raw value (byte array) the key maps to. If the key does not exist
	...
	/**
	 * @return NetworkTables network table
	 */
	...
	/**
	 * @return subtable of NetworkTables
	 */
