...
public class PoseController {
    ...
    public synchronized void updatePoseWithVelocity(Translation2d velocity){
        ...
        Translation2d positionChange = lastPoseUpdate == -1 ? velocity.scale(Robot.bot.POSE_LOOP_DT): velocity.scale(dt);
        currentPose.transformBy(Pose2d.fromTranslation(positionChange));
