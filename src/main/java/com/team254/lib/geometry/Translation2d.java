 ...
 * robot is placed on the origin, facing toward the X direction, moving forward
...
public class Translation2d {
   ...
   * @param y The y component of the translation.
   */
  public Translation2d(final Translation2d other_) {
    m_x = other_.getX();
    m_y = other_.getY();
  }
  ...
  public Translation2d rotateBy(Rotation2d other) {
    return new Translation2d(m_x * other.getCos() - m_y * other.getSin(), m_x * other.getSin() + m_y * other.getCos());
  }
