package com.frcteam2910.common.math;

import com.frcteam2910.common.util.Interpolable;

import java.io.Serializable;
import java.text.DecimalFormat;
import java.util.Objects;

import static com.frcteam2910.common.math.MathUtils.epsilonEquals;
...
public final class Vector2 implements Interpolable<Vector2>, Serializable {
	...
	public boolean equals(Vector2 other, double allowableError) {
		return epsilonEquals(x, other.x, allowableError) &&
				epsilonEquals(y, other.y, allowableError);
	}
