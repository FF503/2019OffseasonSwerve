...
public class SwerveDriveModule extends Subsystem{
	...
	public SwerveDriveModule(int rotationSlot, int driveSlot, int moduleID, 
		...
		motorEncoder = new CANEncoder(driveMotor);
		configureMotors();
	...
	//TODO: Find equivalent in Sparkmmax 
...
//TODO: Find equivalent function in Sparkmax  
...
//		driveMotor.configNominalOutputReverse(-voltage / 12.0, 10);
	...
	private void configureMotors(){
		//rotation motor is a 775 connected to a TALON SRX with analog MA3 encoder 
		...
		//for analog devices you must rest the counter once it hits 1024
	...
	//	}
		...
		//Dive motor is a spark max with internal encoder 
...
//	}
	...
	public synchronized void readPeriodicInputs() {
		...
		if(useDriveEncoder) periodicIO.drivePosition = (int) motorEncoder.getPosition();
		//periodicIO.velocity = driveMotor.getSelectedSensorVelocity();
		if(Constants.kDebuggingOutput){
			//periodicIO.velocity = driveMotor.getSelectedSensorVelocity();
			periodicIO.velocity = (int) motorEncoder.getVelocity();
		}
		/*if(moduleID == 3){
